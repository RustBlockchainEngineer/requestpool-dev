...
namespace MobileServices.Core
{
    ...
    {
        private static string SiteKey { get; set; }
        private static string SecretKey { get; set; }


        public static void Configure(string siteKey, string secretKey)
        {
            SiteKey = siteKey;
            SecretKey = secretKey;
        }
        ...
        {
            SiteKey = ConfigurationManager.AppSettings["CaptchaClientKey"];
            SecretKey = ConfigurationManager.AppSettings["CaptchaSecretKey"];
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetSecureToken(Guid sessionId)
        {
            string result = string.Empty;
            string jsonToken = GetJsonToken(sessionId);
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetSecureTokenHTML(Guid sessionId)
        {
            string result = string.Empty;
            string jsonToken = GetJsonToken(sessionId);
            //Test token with known result:
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetSiteSpecificRecaptchaHTML()
        {
        ...
        private static string GetJsonToken(Guid sessionId)
        {
        ...
        /// </remarks>
        public static RecaptchaValidationResult Validate(string recaptchaResponse)
        {
