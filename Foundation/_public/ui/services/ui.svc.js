...
(function () {
    ...
    function svc($uibModal, uiTinymceConfig) {
        ...
        var viewsPath = root + '/views/ui';
        console.log('root: '+viewsPath);
        var settings = {
            ...
            pageSize: 10,
            images: {
                person: '/wwwroot/_public/images/person.jpg',
                file: '/wwwroot/_public/images/file.png',
                photo: '/wwwroot/_public/images/photo.png',
                icon: '/wwwroot/_public/images/icon.png',
        ...
        function layout() {
            ...
            _layout.getMainContentHeight = function () {
        ...
        function message(options) {
            ...
            $uibModal.open({
                ...
                templateUrl: viewsPath + '/modal.message.html',
        ...
        function confirm(options) {
            ...
            $uibModal.open({
                animation: options.animation || false,
                backdrop: options.backdrop || true,
                templateUrl: viewsPath+'/modal.confirm.html',
                size: options.size || 'sm',
                controller: ['options', '$scope', function (options, $scope) {
                    $scope.options = options;
                }],
        ...
        function confirmDelete(callback,params) {
            confirm({ callback: callback,params:params,message:'Are you sure you want to delete?',type:'danger' });
        }
        var _svc = {
            settings: settings,
