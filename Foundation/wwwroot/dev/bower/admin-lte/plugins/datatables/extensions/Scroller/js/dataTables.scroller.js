...
Scroller.prototype = /** @lends Scroller.prototype */{
	 ...
	 * a given row
	 *  @param {long} iRow Row number to calculate the position of
	 *  @returns {long} Pixels
	 *  @example
	 *    $(document).ready(function() {
	 *      $('#example').dataTable( {
	 ...
	 *  @param {long} iPixels Offset from top to calculate the row number of
	 *  @param {long} [intParse=true] If an integer value should be returned
	 *  @param {long} [virtual=false] Perform the calculations in the virtual domain
	 *  @returns {long} Row index
	 *  @example
	 *    $(document).ready(function() {
	 *      $('#example').dataTable( {
	 *        "sScrollY": "200px",
	 ...
	 *  @param {long} iRow Row index to scroll to
