...
KeyTable = function ( oInit )
{
	...
	function _fnEventAddTemplate( sKey )
	{
		 ...
		 *         or
		 *           1. long:x - x coord. of target cell (can be null for live events)
		 *           2. long:y - y coord. of target cell (can be null for live events)
	...
	function _fnEventRemoveTemplate( sKey )
	{
		 ...
		 * Returns:  long: - number of events removed
	 ...
	 *           long:x - x-coords to add event to - can be null for "blanket" event
	 *           long:y - y-coords to add event to - can be null for "blanket" event
	 ...
	 * Returns:  long: - number of matching events removed
	 ...
	 * Returns:  long:iFired - number of events fired
	 * Inputs:   string:sType - type of event to look for
	 *           long:x - x coord of cell
	 *           long:y - y coord of  ell
	 ...
	 * Returns:  array[2] long: [left, right]
	 ...
	 * Returns:  array[2] long: [x, y] coords. or null if not found
	 ...
	 *   array[2] long:focus - x and y coordinates of the initial target
	 *     or
	 ...
	 *   long:tabIndex - the tab index to give the hidden input element
	 */
